...
class ProductTemplate(models.Model):
    ...
    def _get_own_attribute_exclusions(self):
        ...
        attribute_objs_list = [variant.product_template_attribute_value_ids for variant in self.product_variant_ids if self.marketplace_seller_id and variant.marketplace_status != 'approved']
