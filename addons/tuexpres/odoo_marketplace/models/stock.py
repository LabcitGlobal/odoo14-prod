...
class StockMove(models.Model):
    ...
    def mp_action_show_details(self):
        ...
        if picking_type_id.show_reserved:
            view = self.env.ref('odoo_marketplace.view_stock_move_operations_seller_view')
        else:
            view = self.env.ref('odoo_marketplace.view_stock_move_nosuggest_operations_seller_view')
