...
class pos_config(models.Model):
	...
	pos_overlay_order = fields.Boolean(string='Block out of stock products')
	pos_online_check_stock = fields.Boolean(string='Check the stock online before paying', default=False)
	pos_sync = fields.Boolean(string='Carry Stock Synchronization in real time', default=False)
...
class stock_quant(models.Model):
	...
	def get_products_stock_all_qty(self, products):
		res = {}
