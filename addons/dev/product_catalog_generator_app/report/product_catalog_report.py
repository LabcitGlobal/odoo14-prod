...
class ProductCatalogReportStyle1(models.AbstractModel):
	_name = 'report.product_catalog_generator_app.report_product_style_1' 
	...
	def _get_product_link(self, product):
		...
		website_url = str(base_url) + "/shop/product/" + str(product.product_tmpl_id.id)
		return website_url
...
class ProductCatalogReportStyle2(models.AbstractModel):
	_name = 'report.product_catalog_generator_app.report_product_style_2' 
	_description = 'Product Catalog Report Style'
...
class ProductCatalogReportStyle3(models.AbstractModel):
	_name = 'report.product_catalog_generator_app.report_product_style_3' 
	_description = 'Product Catalog Report Style'
...
class ProductCatalogReportStyle4(models.AbstractModel):
	_name = 'report.product_catalog_generator_app.report_product_style_4' 
	_description = 'Product Catalog Report Style'
...
class ProductCatalogReportStyle5(models.AbstractModel):
	_name = 'report.product_catalog_generator_app.report_product_style_5' 
	_description = 'Product Catalog Report Style'
